 ...
 *
 * Google OAuth sign-in button with brand styling.
 */
  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        "border border-gold-luxury/20 hover:border-gold-luxury/40",
        "bg-white/5 hover:bg-white/8 backdrop-blur-sm",
        "text-cream-white text-sm font-semibold tracking-wide",
        "transition-all duration-300",
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-luxury",
